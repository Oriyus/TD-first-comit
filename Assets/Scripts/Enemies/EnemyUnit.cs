    ...
    public class EnemyUnit : MonoBehaviour
    {
        ...
        public void DamageEnemy(int dmg)
        {
            ...
            if (this.enemy.health <= 0)
            {
                ...
                // Drop loot
                OnLootDropedEvent?.Invoke(this.enemy.loot, this.transform);
                // Destroy enemy
                Destroy(gameObject);
            }
        }
        ...
        {
            this.transform.position = Vector2.MoveTowards(this.transform.position, this.path[this.index].position, this.enemy.speed * Time.deltaTime);
